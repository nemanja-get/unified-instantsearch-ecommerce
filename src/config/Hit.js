    ...
    >
      <a href="#" className="uni-Hit-inner">
        ...
        <div className="uni-Hit-image">
          <img src={'https://static.ananas.rs' + hit.image_url} alt={hit.name} loading="lazy" 
              onMouseOver={e => (e.target.src = 'https://static.ananas.rs' + hit.hover_image)}
              onMouseOut={e => (e.target.src = 'https://static.ananas.rs' + hit.image_url)} />
        </div>
        ...
        <div className="uni-Hit-Body">
          ...
          <footer className="uni-Hit-footer">
              <p className="uni-Hit-free-shipping">{inStock}</p>
              <span className="uni-Hit-currency">$</span>
              <span className="uni-Hit-price">{hit.price.toLocaleString()}</span>
              <div style="margin-top: 1rem;">
              {stars.map((e, starIndex) => {
                const isStarFull = starIndex < hit.rating;
